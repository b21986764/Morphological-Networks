...
# Full DeepMorphNet architecture adapted for MNIST
class DeepMorphNet(nn.Module):
    def __init__(self, num_classes=10):
        ...
        self.layer1 = MorphologicalLayer(1, 32, kernel_size=5)  # Adapted for grayscale input
        self.layer2 = MorphologicalLayer(32, 64, kernel_size=5)
        
        self.flatten_size = None  # To be set dynamically

        # Fully connected layers
        self.fc1 = None  # Will be initialized later
        self.fc2 = nn.Linear(1024, 512)  # Adjust based on flatten size during runtime
